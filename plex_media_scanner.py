...
plex_token={'X-Plex-Token':'Plex Token goes here. You can get this by viewing the XML in the plex web interface for any media item, it will be in the URL.'}
port_num='32400'
...
if __name__=='__main__':
    ...
    parser.add_argument("--LibraryID",required=True,help='Plex Library ID to refresh')
